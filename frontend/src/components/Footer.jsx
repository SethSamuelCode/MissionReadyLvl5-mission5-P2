  ...
  return (
    <footer className={styles.footerContainer}>
      ...
      <div className={styles.linkListContainer}>
        <div>
          <Link className={styles.BoldLinks} to="/marketplace">
            Marketplace
          </Link>
          <ul>
            <li>Latest Deals</li>
        ...
        <div>
          <Link className={styles.BoldLinks} to="/property">
            Property
          </Link>
          <ul>
        ...
        <div>
          <Link className={styles.BoldLinks} to="/motors">
            Motors
          </Link>
          <ul>
        ...
        <div>
          <Link className={styles.BoldLinks} to="/jobs">
            Jobs
          </Link>
          <ul>
        ...
        <div>
          <Link className={styles.BoldLinks} to="/services">
            Services
          </Link>
          <ul>
            <li>Trades</li>
        ...
        <div>
          <Link className={styles.BoldLinks} to="/community">
            Community
          </Link>
          <ul>
            <li>Help</li>

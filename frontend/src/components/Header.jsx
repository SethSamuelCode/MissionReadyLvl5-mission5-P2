    ...
    <header className={styles.fullHeader}>
      <div className={styles.topHeader}>
        ...
        <ul className={styles.actionBar}>
          ...
          <li>
            <Link
              to="https://www.trademe.co.nz/a/login"
      ...
      <div className={styles.bottomHeader}>
        <ul className={styles.navCatergoryTabs}>
          ...
          <li>
            <Link to="https://www.trademe.co.nz/a/marketplace/stores">
              Stores
            </Link>
          </li>
          <li>
            <Link to="https://www.trademe.co.nz/a/marketplace/search?deal_promotion_id=11">
              Deals
            </Link>
          </li>

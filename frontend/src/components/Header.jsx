        ...
        <ul className={styles.userNavigationList}>
          <li>
            <div className={styles.listIconContainer}>
              ...
              >
                <path
                  d="M20 22.5H4C3.73478 22.5 3.48043 22.3946 3.29289 22.2071C3.10536 22.0196 3 21.7652 3 21.5V3.5C3 3.23478 3.10536 2.98043 3.29289 2.79289C3.48043 2.60536 3.73478 2.5 4 2.5H20C20.2652 2.5 20.5196 2.60536 20.7071 2.79289C20.8946 2.98043 21 3.23478 21 3.5V21.5C21 21.7652 20.8946 22.0196 20.7071 22.2071C20.5196 22.3946 20.2652 22.5 20 22.5ZM19 20.5V4.5H5V20.5H19ZM8 7.5H16V9.5H8V7.5ZM8 11.5H16V13.5H8V11.5ZM8 15.5H16V17.5H8V15.5Z"
                  fill="#2F2C28"
                />
              </svg>
            </div>
          ...
          <li>
            <div className={styles.favouritesContainer}>
              ...
              >
                <path
                  d="M12.1 8.64l-.1.1-.1-.1C10.14 6.6 7.28 6.6 5.32 8.55c-1.96 1.95-1.96 5.12 0 7.07L12 22.3l6.68-6.68c1.96-1.95 1.96-5.12 0-7.07-1.96-1.95-4.82-1.95-6.78 0z"
                  stroke="#2F2C28"
                  strokeWidth="2"
                  fill="none"
                />

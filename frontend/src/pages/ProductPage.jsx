...
export default function ProductPage() {
    ...
    async function setSimilarItemsVar() {
      try {
        const response = await fetch(
          `${BACKEND_URL}/randomByField/category/${itemCategory}/10`
        )
  ...
  if (!loaded) {
    return (
      <div>
        <Header />
        <div className={styles.loading}>Loading...</div>; // Show loading state
    ...
    <div className={styles.container}>
      ...
      <div className={styles.section1}>
        <div className={styles.images}>
          <img src={imageUrl} alt="Random product" />
        ...
        <div className={styles.sidebar}>
          ...
          <div className={styles.watchListAndCompareButtons}>
            <button>
              <img src={watchListIcon} alt="Watchlist Icon" /> Add to Watchlist
            </button>
            <button>
